...
namespace CAPA_DATOS
{
    public class CD_HORARIOS
    {
        ...
        public void InsertarHorario(CE_HORARIOS obj, out int resultado, out string mensaje)
        {
            ...
            {
                throw new Exception($"Error al ingresar asignatura: " + ex.Message);
            }
            finally
            {
        ...
        public List<CE_HORARIOS> FiltrarHorarios_Id(CE_HORARIOS obj) //Todo metodo de tipo Lista debe constar de informacion para mostrarla
        {
            List<CE_HORARIOS> lts_horarios = new List<CE_HORARIOS>(); //Creando la informacion
            cmd.Connection = _connection.AbrirConexion(); //Abrimos la conexion
            cmd.CommandText = "SP_HORARIOS"; //Parametro nombre del procedimiento almacenado
