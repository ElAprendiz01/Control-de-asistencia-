...
namespace CAPA_DATOS
{
    public class CD_ASISTENCIAS
    {
        ...
        public void InsertarAsistencia(CE_ASISTENCIAS obj, out int resultado, out string mensaje)
        {
            ...
            {
                throw new Exception($"Error al ingresar la asistencia: " + ex.Message, ex);
            }
            finally
            {
        ...
        public List<CE_ASISTENCIAS> FiltrarAsistenciaID(CE_ASISTENCIAS obj)
        {
            ...
            cmd.Parameters.Add("@Id_Asistencia", SqlDbType.Int).Value = obj.Id_Asistencia;
