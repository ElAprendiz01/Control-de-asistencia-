...
namespace CAPA_NEGOCIO
{
    public class CN_GRUPO_ASIGNATURA
    {
        ...
        public void CN_Insertar_Grupo_Asignatura(CE_GRUPO_ASIGNATURA obj_GA, out int resultado, out string mensaje)
        {
            _cd_GA.InsertarGrupoAsignatura(obj_GA, out resultado, out mensaje);
        }
        ...
        {
            return _cd_GA.FiltrarGrupoAsignaturaID(obj_GA);
        }
