...
namespace CAPA_NEGOCIO
{
    public class CN_DATOS_PERSONALES
    {
        ...
        public void CN_Insertar_Datos_Personales(CE_DATOS_PERSONALES obj_Datos_Personales, out int resultado, out string mensaje)
        {
            _CDDatos_Personales.InsertarDatosPersonales(obj_Datos_Personales, out resultado, out mensaje);
