...
namespace CAPA_NEGOCIO
{
    public class CN_ASIGNATURAS
    {
        ...
        public void CN_Insertar_Asignaturas(CE_ASIGNATURAS obj_asignaturas, out int resultado, out string mensaje)
        {
            _CD_Asignaturas.InsertarAsignaturas(obj_asignaturas, out resultado, out mensaje);
        }
