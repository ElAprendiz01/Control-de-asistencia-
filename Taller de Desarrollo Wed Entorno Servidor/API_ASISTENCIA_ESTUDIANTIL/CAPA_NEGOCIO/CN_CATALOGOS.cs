...
namespace CAPA_NEGOCIO
{
    public class CN_CATALOGOS
    {
        ...
        public void CN_Insertar_Catalogos(CE_CATALOGOS obj_Catalogos, out int resultado, out string mensaje)
        {
            _CDCatalogos.InsertarCatalogo(obj_Catalogos, out resultado, out mensaje);
