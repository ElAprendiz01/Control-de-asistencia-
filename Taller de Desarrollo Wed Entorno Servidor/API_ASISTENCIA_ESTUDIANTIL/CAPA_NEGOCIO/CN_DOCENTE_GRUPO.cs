...
namespace CAPA_NEGOCIO
{
    public class CN_DOCENTE_GRUPO
    {
        ...
        public void CN_Insertar_Docente_Grupo(CE_DOCENTE_GRUPO _CE_DG, out int resultado, out string mensaje)
        {
            _CD_DG.InsertarDocenteGrupo(_CE_DG, out resultado, out mensaje);
        }
