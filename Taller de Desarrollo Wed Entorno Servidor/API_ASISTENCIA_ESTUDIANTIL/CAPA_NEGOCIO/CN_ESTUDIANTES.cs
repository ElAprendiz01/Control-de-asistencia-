...
namespace CAPA_NEGOCIO
{
    public class CN_ESTUDIANTES
    {
        ...
        public void CN_Insertar_Estudiante(CE_ESTUDIANTES obj_estudiantes, out int resultado, out string mensaje)
        {
            _CD_Estudiantes.InsertarEstudiantes(obj_estudiantes, out resultado, out mensaje);
        }
