...
namespace CAPA_NEGOCIO
{
    public class CN_DOCENTES
    {
        ...
        public void CN_Insertar_Docente(CE_DOCENTES obj_docentes, out int resultado, out string mensaje)
        {
            _CD_Docentes.InsertarDocentes(obj_docentes, out resultado, out mensaje);
        }
