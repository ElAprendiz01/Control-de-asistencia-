...
namespace CAPA_NEGOCIO
{
    public class CN_ESTADOS
    {
        ...
        public void CN_Insertar_Estados(CE_ESTADOS _CE_ESTADOS, out int resultado, out string mensaje)
        {
            _CD_ESTADOS.InsertarEstados(_CE_ESTADOS, out resultado, out mensaje);
        }
