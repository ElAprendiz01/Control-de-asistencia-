...
namespace CAPA_NEGOCIO
{
    public class CN_GRUPO_TURNO
    {
        ...
        public void CN_Insertar_Grupo_Turno(CE_GRUPO_TURNO obj_GT, out int resultado, out string mensaje)
        {
            _cd_GT.InsertarGrupoTurno(obj_GT, out resultado, out mensaje);
        }
        ...
        {
            return _cd_GT.FiltrarGrupoTurnoID(obj_GT);
        }
    }
}
