...
namespace CAPA_NEGOCIO
{
    public class CN_ASISTENCIAS
    {
        ...
        public void CN_Insertar_Asistencia(CE_ASISTENCIAS _CE_Asistencias, out int resultado, out string mensaje)
        {
            _CD_Asistencias.InsertarAsistencia(_CE_Asistencias, out resultado, out mensaje);
        }
        ...
        {
           return _CD_Asistencias.FiltrarAsistencia(_CE_Asistencias);
        }
