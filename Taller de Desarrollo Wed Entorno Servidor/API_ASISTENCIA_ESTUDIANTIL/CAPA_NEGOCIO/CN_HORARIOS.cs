...
namespace CAPA_NEGOCIO
{
    public class CN_HORARIOS
    {
        ...
        public void CN_Insertar_Horarios(CE_HORARIOS obj_Horarios, out int resultado, out string mensaje)
        {
            _CDHorarios.InsertarHorario(obj_Horarios, out resultado, out mensaje);
       ...
       public List<CE_HORARIOS> CN_Filtrar_Horarios(CE_HORARIOS obj_Horarios)
        ...
        {
            return _CDHorarios.FiltrarHorarios_Id(obj_Horarios);
        }
    }
}
