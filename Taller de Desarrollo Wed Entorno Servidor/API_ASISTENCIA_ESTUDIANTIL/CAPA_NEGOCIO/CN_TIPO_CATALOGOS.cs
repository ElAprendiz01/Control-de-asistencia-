...
namespace CAPA_NEGOCIO
{
    public class CN_TIPO_CATALOGOS
    {
        ...
        public void CN_Insertar_Tipo_Catalogos(CE_TIPO_CATALOGOS obj, out int resultado, out string mensaje)
        {
            _CD_Tipo_Catalogos.InsertarTipoCatalogo(obj, out resultado, out mensaje);
        }
