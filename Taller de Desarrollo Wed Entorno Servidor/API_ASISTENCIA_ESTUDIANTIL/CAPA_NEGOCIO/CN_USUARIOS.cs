...
namespace CAPA_NEGOCIO
{
    public class CN_USUARIOS
    {
        ...
        public void CN_Actualizar_Usuarios(CE_USUARIOS obj_Usuarios, out int resultado, out string mensaje)
        {
            _CDUsuarios.ActualizarUsuarios(obj_Usuarios, out resultado, out mensaje);
        }
        ...
        public void CN_Login_Usuario(string usuario,  string contrasena, out int resultado, out string mensaje)
        {
             _CDUsuarios.Loggear_Usuario(usuario, contrasena, out resultado, out mensaje);
        }

        public UsuarioDTO CN_ObtenerUsuario(string usuario, string contrasena, out string mensaje, out int resultado)
        {
            return _CDUsuarios.Get_User(usuario, contrasena, out mensaje, out resultado);
        }
