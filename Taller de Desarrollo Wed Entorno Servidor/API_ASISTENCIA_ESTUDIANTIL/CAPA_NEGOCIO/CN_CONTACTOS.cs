...
namespace CAPA_NEGOCIO
{
    public class CN_CONTACTOS
    {
        ...
        public void CN_Insertar_Contactos(CE_CONTACTOS obj_Contactos, out int resultado, out string mensaje)
        {
            _Cd_Contactos.InsertarContacos(obj_Contactos, out resultado, out mensaje);
        }
