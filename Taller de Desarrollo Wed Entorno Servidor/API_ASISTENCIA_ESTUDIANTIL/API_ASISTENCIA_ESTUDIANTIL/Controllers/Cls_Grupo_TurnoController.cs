...
namespace API_ASISTENCIA_ESTUDIANTIL.Controllers
{
    ...
    public class Cls_Grupo_TurnoController : ControllerBase
    {
        ...
        [HttpGet("BUSCAR_GRUPO_TURNO_POR_HORARIO")]

        public ActionResult<List<CE_GRUPO_TURNO>> FiltrarGrupoTurnoID([FromQuery] int? Id_Horario)
        {
        ...
        public ActionResult<List<CE_GRUPO_TURNO>> FiltrarGrupoTurno([FromQuery] int? Id_Grupo_Turno)
        {
            _CE_GT.Id_Grupo_Turno = Id_Grupo_Turno;

            var resultado = _CN_GT.CN_Filtrar_Grupo_TurnoID(_CE_GT);
        ...
        public ActionResult InsertarGrupoTurno([FromBody] ApiModels.AM_GRUPO_TURNO _am_GT)
        {
            ...
            try
            {
                _CN_GT.CN_Insertar_Grupo_Turno(_CE_GT, out resultado, out mensaje);
