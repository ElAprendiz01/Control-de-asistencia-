...
namespace API_ASISTENCIA_ESTUDIANTIL.Controllers
{
    ...
    public class Cls_Estudiante_GrupoController : ControllerBase
    {
        ...
        public ActionResult<List<CE_ESTUDIANTE_GRUPO>> FiltrarEstudianteGrupoID([FromQuery] int? Id_Estudiante_Grupo)
        ...
        public ActionResult<List<CE_ESTUDIANTE_GRUPO>> FiltrarEstudianteGrupo([FromQuery] int? Id_Estudiante)
        {
