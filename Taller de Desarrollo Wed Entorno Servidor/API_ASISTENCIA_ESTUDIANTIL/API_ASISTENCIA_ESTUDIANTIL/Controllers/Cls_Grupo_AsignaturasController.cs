...
namespace API_ASISTENCIA_ESTUDIANTIL.Controllers
{
    ...
    public class Cls_Grupo_AsignaturasController : ControllerBase
    {
        ...
        public ActionResult<List<CE_GRUPO_ASIGNATURA>> FiltrarGrupoAsignatura([FromQuery] int? Id_Grupo)
        {
        ...
        public ActionResult<List<CE_GRUPO_ASIGNATURA>> FiltrarGrupoAsignaturaID([FromQuery] int? Id_Grupo_Asignatura)
        {
            _CE_GA.Id_Grupo_Asignatura = Id_Grupo_Asignatura;

            var resultado = _CN_GA.CN_Filtrar_Grupo_AsignaturaID(_CE_GA);
        ...
        public ActionResult<List<CE_GRUPO_ASIGNATURA>> InsertarGrupoAsignatura([FromBody] ApiModels.AM_GRUPO_ASIGNATURA _am_GA)
        {
            ...
            try
            {
                _CN_GA.CN_Insertar_Grupo_Asignatura(_CE_GA, out resultado,out mensaje);
