...
namespace API_ASISTENCIA_ESTUDIANTIL.Controllers
{
    ...
    public class Tbl_AsistenciasController : ControllerBase
    {
        ...
        public ActionResult<List<CE_ASISTENCIAS>> FiltrarAsistencias([FromQuery] int? Id_Asistencia)
        ...
        public ActionResult<List<CE_ASISTENCIAS>> FiltrarAsistencias([FromQuery] int? Id_Estudiante_Grupo, 
        ...
        public ActionResult InsertarDocenteGrupo([FromBody] ApiModels.AM_ASISTENCIAS _am_Asistencias)
        {
            ...
            try
            {
                _CN_Asistencias.CN_Insertar_Asistencia(_CE_Asistencias, out resultado, out mensaje);
