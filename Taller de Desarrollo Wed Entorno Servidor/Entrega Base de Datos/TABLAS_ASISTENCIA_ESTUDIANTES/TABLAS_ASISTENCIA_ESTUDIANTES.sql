...
Asistio VARCHAR(20) NOT NULL,  -- 1: Asisti�, 0: No asisti�
...
CREATE TABLE Tbl_Permisos_Roles(
	Id_Permiso INT PRIMARY KEY IDENTITY(1,1),
    Id_Rol INT FOREIGN KEY (Id_Rol) REFERENCES Tbl_Roles_Usuarios ,
    Modulo VARCHAR(50),
    PuedeInsertar BIT,
    PuedeEditar BIT,
    PuedeVisualizar BIT,
	PuedeFiltrarNombre BIT,
	PuedeFiltrarId BIT,
)
GO
